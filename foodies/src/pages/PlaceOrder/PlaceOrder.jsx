      ...
      try {
        const response = await axios.post("http://localhost:8080/api/orders/verify" , paymentData, {headers: {'Authorization': `Bearer ${token}`}});
          if (response.status === 200) {
            toast.success("Paymnent Succesful.");
            await clearCart();
            navigate('/myorders');
          } else {
      ...
      <div className="col-md-5 col-lg-4 order-md-last">
        ...
        <ul className="list-group mb-3">
          ...
          <li className="list-group-item d-flex justify-content-between">
            ...
            <span className="text-body-secondary">&#8377{subtotal === 0 ? 0.0 : shipping.toFixed(2)}</span>
          </li>
          <li className="list-group-item d-flex justify-content-between lh-sm">
            <div>
        ...
        <form className="needs-validation" onSubmit={onSubmitHandler}>
          <div className="row g-3">
            <div className="col-sm-6">
              ...
              <input type="text" className="form-control" id="firstName" placeholder="" required name="firstName" onChange={onChangeHandler} value={data.firstName}/>
              
            </div>

            <div className="col-sm-6">
              <label htmlFor="lastName" className="form-label">Last name</label>
              <input type="text" className="form-control" id="lastName" placeholder="" name="lastName" onChange={onChangeHandler} value={data.lastName} required />
            ...
            <div className="col-12">
              ...
              <input type="number" className="form-control" id="phone" placeholder="1234567890" required name="phoneNumber" onChange={onChangeHandler} value={data.phoneNumber}/>
            </div>
            <div className="col-12">
            ...
            <div className="col-md-3">
              ...
              <input type="number" className="form-control" id="zip" placeholder="282001" required name="zip" onChange={onChangeHandler} value={data.zip}/>
